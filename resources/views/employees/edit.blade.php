...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header" style="background-color: #ffeeba;">Update employee information</div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('employees.update', $employee->id) }}">
                            ...
                            <button type="submit" class="btn btn-primary" style="background-color: #ffeeba; color:black; border-color:grey;">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
